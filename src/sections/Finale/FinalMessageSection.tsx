...
import { HeartIcon, SparkleIcon, StarIcon } from '../../components/ui/DecorativeShapes';
    ...
    <div className="relative min-h-screen w-full flex flex-col justify-between p-4 sm:p-8 overflow-x-hidden z-10 max-w-5xl mx-auto">
      ...
      >
        <div className="relative rounded-3xl bg-white/95 backdrop-blur-md p-6 sm:p-12 shadow-[0_15px_45px_rgba(216,27,96,0.14)] border-2 border-[#F48FB1] space-y-8">
          ...
          {/* Letter Body */}
          <div className="space-y-6 text-[#2B1525] text-lg sm:text-xl leading-loose font-normal">
            <p
              dir="auto"
              className="font-display text-3xl sm:text-4xl text-[#1A0D18] italic font-bold"
            >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 z-10 py-6 max-w-3xl mx-auto w-full">
        <button
          ...
          className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-white border-2 border-[#D81B60] hover:bg-[#FFEAF2] text-xs sm:text-sm uppercase tracking-widest text-[#D81B60] font-bold transition-all duration-300 shadow-sm hover:scale-105 active:scale-95 focus:outline-none cursor-pointer"
        >
