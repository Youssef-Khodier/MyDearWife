...
export const timelineData: TimelineMemory[] = [
  {
    ...
    description: 'بداية بدأت بصدفة، و أحلى صدفة حصلت. مين يتخيل إن علشان أوقفك مكاني في كانتين المدرسة، يوصلنا إننا نعيش مع بعض العمر ده كله و نتجوز؟ مين يتخيل علشان كنتي ماسكه حاجة سخنة يخلي ده يحصل؟ عشنا يا روحي الفترة ديه، و عدينا بحاجات كتير اوي سوا، و مع كل الي حصل خلصت بإننا مع بعض زي دايما، و زي ما هيحصل على طول يا روح قلبي.',
    images: [],
    ...
    subSections: [
      {
        ...
        description: "هنا حصلت الحاجة الي لحد دلوقتي فاكرها و فاكر إحساسها. هنا حضنتك لأول مرة يا مريم، و لأول مرة اتحضن في حياتي، و كان منك. و لحد دلوقتي يا مريم عارف الإحساس و حافظه، و بفتكره في كل لحظه في حياتي، و مش عاوز غيره في حياتي كلها.",
        images: [
          {
      ...
      },
      {
        ...
        description: "هنا كنا دخلنا ثانوية عامة، و رجعنا لنفس العادة نتقابل بعد الدرس و نروح سوا. و هنا حصلت حاجة الي مكنتش متخيل انها تحصل: قابلت طنط لأول مرة، و كمان خلتني أركب معاكم. ده أكبر حدث في حياتي والله، و قد إيه ديه حاجة كبيره بنسبالي. مكنتش متصور ده يحصل، و حصل مرتين. بجد حدث كبير جدا.",
        images: [
          {
  ...
  },
  {
    ...
    description: "هنا خلصنا ثانوية، و بدأنا نشوف الدنيا و نخش جامعة، و فضلنا متمسكين ببعض و مصرّين على بعض. و فضلنا مش شايفين غير بعض في الدنيا كلها، و عمري ما أشوف غيرك يا مريم والله العظيم. أنا مش عايز غيرك من الدنيا مهما حصل، عاوزك انتي.",
    images: [
      {
  ...
  },
  {
    ...
    description: "هنا خلاص بقا صعنا خالص، و بقينا نخرج من الصبح و نروح بليل، و نقضي مع بعض اليوم كامل و نعمل حاجات كتير اوي. نجيب لعب و نلعبها مع بعض، نجرب أماكن، نتمشي حتي، و خلاص عملنا حاجات كتير اوي السنة ديه، و بجد من أحلى سنين حياتي.",
    images: [
      {
  ...
  },
  {
    ...
    description: "سنين يا مريم سوا، سنين مع بعض. محستش بلحظه بزهق، محستش لحظه بأي حاجة غير إني عاوزك، عاوزك جنبي، عاوزك معايا في أي حاجة. عاوز نبقى سوا و بس، سنين. و أنا بحلم باليوم الي هتجوزك فيه، و هيجي يا مريم والله العظيم هيجي. هدفي الوحيد ربنا يخليكي ليا يا حبيبتي، و يا أحلى حاجة في حياتي.",
    images: [
      {
...
export const birthdayData: BirthdayData = {
  ...
  finale: {
    ...
    letterParagraphs: [
      "كل سنة و انتي طيبة، يا روح قلبي. كل سنة و انتي معايا، كل سنة و انتي أجمل و أحلى بنت اشوفها في حياتي، كل سنة و احنا سوا في كل حاجة الحلو و الوحش.",
      "كبرتي يا مريم، متخيلة بقالنا قد إيه سوا؟ و كل ده و لسه قدامنا كتير يا روحي، لسه قدامنا العمر كله سوا. ربنا يخليكي ليا يا حبيبتي، و ميحرمنيش منك ولا لحظه. أنا يا مريم حياتي قايمة عليكي، حياتي كلها قايمة على اليوم الي يتقفل فيه علينا باب واحد في بيتنا و نتجوز. يا مريم، أنا بحلم باليوم ده في كل لحظه في حياتي.",
      "كبرتي و بقيتي 20 سنة، متخيلة؟ بقيتي آنسة خلاص. آنسة مريم راحت، آنسة مريم جت، آنسة 20 بقا.",
      "أنا بحبك اوي يا مريم، و مش عاوز غيرك في دنيتي والله. انتي أحلى حاجة حصلتلي و هتحصلي.",
      "ربنا يخليكي ليا يا حبيبتي.",
      "هتجوزك والله العظيم يا مريم."
    ],
    letterClosing: "",
